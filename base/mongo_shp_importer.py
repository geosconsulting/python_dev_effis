...
input_shape = '/media/sf_Downloads/__effis/effis_ubuntu/dati_test_shp/portogallo/test_ba_portogallo.shp'
# output_shape = '/media/sf_Downloads/__effis/effis_ubuntu/dati_test_shp/current_ba/output.shp'
driver = ogr.GetDriverByName('ESRI Shapefile')
...
mongodb_port = 27017
mongodb_db = 'gwis'
mongodb_collection = 'burnt_areas'
